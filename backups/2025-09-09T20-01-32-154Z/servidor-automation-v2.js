...
const { verificarEProcessarLocalizacoesFaltantes } = require('../vincularOJ.js');
...
`;
  ...
  async processOrgaoJulgador(orgao) {
    ...
    // Verificação de cache rápida como fallback
  ...
  async processOrgaosJulgadoresWithServerTracking(servidor) {
    ...
    // Verificar OJs já cadastrados em lote usando SmartOJCache
    console.log(`🔍 [DEBUG] Carregando OJs existentes para ${servidor.nome} usando SmartOJCache...`);
    await this.loadExistingOJsWithSmartCache();
    ...
    // ANÁLISE INTELIGENTE: Verificar se servidor deve ser pulado
